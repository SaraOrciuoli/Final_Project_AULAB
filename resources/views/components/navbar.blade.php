    ...
    <div class="container-fluid containerNav sticky-top">
        ...
        <div class="container-fluid my-1">
            ...
            <a class="navbar-brand p-0" href="{{ route('homepage') }}"><img class="logo" src="/media/logo1.png" alt="Logo"></a>
                ...
                <div class="d-block d-md-flex">
                    ...
                    <form method="GET" action="{{ route('search_announcements') }}" class="d-flex me-2">
                        <input type="search" name="searched" class="form-control me-2" placeholder="Ricerca"
                            aria-label="Search">
                        <button class="btn d-none d-md-block" type="submit">Ricerca</button>
                    </form>
                    {{-- Logout --}}
                    @auth
